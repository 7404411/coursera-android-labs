...
public class DownloaderTaskFragment extends Fragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		List<Integer> friendsList = args.getIntegerArrayList("friends");
		Integer[] friendsArray = new Integer[friendsList.size()];
		friendsArray = friendsList.toArray(friendsArray);
		dlTask.downloadTweets(friendsArray);
		dlTask.doInBackground(friendsArray);
		// TODO: Start the DownloaderTask
		dlTask.execute(friendsArray);
